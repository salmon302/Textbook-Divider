...
class TestLewinMultiColumn(unittest.TestCase):
	@classmethod
	def setUpClass(cls):
		...
		cls.output_dir = cls.base_dir / "tests/phase_3_5/output/lewin_multi"
		...
		# Pages to test (focusing on sections with multi-column layouts and math)
		cls.test_pages = [10, 25, 50, 75, 100]
